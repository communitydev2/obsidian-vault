...
Stack : React, Node.js, Mongodb, Typescript, React Testing Library, Redux

  

Responsibilities: Handling Kitchen user section in backend and frontend and integration with other areas of the restaurant.
...
Customer’s Request: Develop a static web application for their restaurant with order system using Mongodb
...
- Boosted business’s food orders by 30%.
...
- Develop new features according to customer’s request
...
- Boosted Business workflow by 90% in this task
...
When a video game trailer is complete, there are a large number of versions that have to be created for different game platforms.
...
Result: From one video and a set up template in After Effects, it generates all versions for all game platforms with one click.

  

- Boosted business productivity by 30%
    
- Reduced human error by 90% in trailer versioning
...
- Automated a 2h task into a few minutes
    
- Boosted business productivity by 5%
